...
class Utilisateurs extends \Utilisateurs\UtilisateursBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'surname', 'nickname', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'imageFile', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'image', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'imageSize', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'updatedAt', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
