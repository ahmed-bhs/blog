...
return $twig->render($entityConfiguration['templates']['label_inaccessible'], array('view'=> $view,'backend_config'=> $this->getBackendConfiguration(),'entity_config'=> $entityConfiguration,
));
}
try {
$fieldType = $fieldMetadata['dataType'];
$templateParameters = array('field_options'=> $fieldMetadata,'item'=> $item,'value'=> $value,'view'=> $view,'backend_config'=> $this->getBackendConfiguration(),'entity_config'=> $entityConfiguration,
);
if (null === $value) {
