...
use Gt\ItBundle\Entity\Tag;
use Gt\ItBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GtItBundle:Tag')->findAll();

        return $this->render('GtItBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('GtItBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GtItBundle:Tag')->find($id);
        ...
        return $this->render('GtItBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GtItBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
