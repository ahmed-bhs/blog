...
class BlogAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GtItBundle:Blog')->findAll();
        $comments = $em->getRepository('GtItBundle:Comment')->findAll();

        return $this->render('GtItBundle:Blog:index.html.twig', array(
            'entities' => $entities,'comments'=>$comments
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('GtItBundle:Blog:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GtItBundle:Blog')->find($id);
        ...
        return $this->render('GtItBundle:Blog:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GtItBundle:Blog:edit.html.twig', array(
            'entity'      => $entity,
